...
export const BlockspanneTab: React.FC<BlockspanneTabProps> = ({ patient, previousResults, onSave, onUpdate, onDelete }) => {
  ...
  const prVorwaerts = vwVal !== null ? lookupBlockspanne(vwVal, ageAtTest, 'vorwaerts') : null;
  const prRueckwaerts = rkVal !== null ? lookupBlockspanne(rkVal, ageAtTest, 'rueckwaerts') : null;
  ...
  return (
    <div className="space-y-4" ref={containerRef}>
      ...
      <div className="px-4 py-2.5 rounded-2xl bg-white border border-slate-100">
        ...
        <span className="text-[11px] text-gray-400">WMS-R Blockspanne (VM 3) – alterskorrigierte Normtabelle · Vorwärts → Merkspanne · Rückwärts → Arbeitsgedächtnis</span>
      </div>
